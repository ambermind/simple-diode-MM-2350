# simple-diode-MM-2350
A simple network diode for the [MM-2350 board](https://minimacy.net/MM-2350.html)

This program implements a simple network diode that allows only UDP traffic to flow from left to right.

This demo works only on the MM-2350 board.

Documentation is here: [Network diode](https://minimacy.net/book/#/tag/diode)
